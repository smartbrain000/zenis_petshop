        ...
        <div class="panjang">
            <div>
                ...
                if ($_POST["id"]) {
                    ...
                    $query2 = mysqli_query($koneksi, "SELECT * FROM struk a WHERE id_struk='" . $_POST['id'] . "'");
                ...
                <table>
                    <tr>
                        <td>Total : </td>
                        <td align="right">
                            <?= number_format($t['total_harga']) ?>
                        </td>
                    </tr>
                    <tr>
                        <td>Diskon :</td>
                        <td align="right"><?= number_format($t['diskon']) ?></td>
                    </tr>
                    <tr>
                        <td>Bayar :</td>
                        <td align="right"><?= number_format($t['tunai']) ?></td>
                    </tr>
                    <tr>
                        <td>Kembali : </td>
                        <td align="right">
                            <?= number_format($t['kembalian']); ?>
                        </td>
                    </tr>
                </table>
                <!-- </div> -->
